...
The environment
  ...
  moat provider          which endpoint moat talks to, and the key it uses
  ...
  moat snapshot [name]   save the rootfs, including everything installed in it
  moat restore <name>    put that rootfs back; the project's work is kept
